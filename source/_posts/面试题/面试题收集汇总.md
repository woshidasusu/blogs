...
3.  内存模型以及垃圾回收机制
4.  [内存泄漏概念、监控和分析](https://github.com/woshidasusu/Doc/blob/master/面试题/浏览器/内存泄漏.md)
5.  [本地存储（cookie, localStorage, sessionStorage）](https://github.com/woshidasusu/Doc/blob/master/面试题/浏览器/本地缓存.md)
